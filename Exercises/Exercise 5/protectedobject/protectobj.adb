...
procedure protectobj is
    ...
    protected body Resource is
        ...
        entry allocateLow(val: out IntVec.Vector) when not busy and 0 = allocateHigh'Count and 0 < allocateLow'Count is
        begin
        ...
        entry allocateHigh(val: out IntVec.Vector) when not busy and 0 < allocateHigh'Count is
        begin
